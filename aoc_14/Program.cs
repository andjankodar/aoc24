...
{
    var matches = Regex.Matches(lines[i], "(-*\\d+)").Select(x => int.Parse(x.Value)).ToArray();
...
for(int j = 0; j < bots.Length; j++)
{
    ...
    Console.WriteLine($"X={newPos.pX}, Y={newPos.pY}");
...
Console.WriteLine($"Q1: {q1}, Q2: {q2}, Q3: {q3}, Q4:{q4} Total: {q1 * q2 * q3 * q4}");
